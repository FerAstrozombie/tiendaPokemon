    ...
    return (<div className="menu">
        ...
        <nav className={`cabeceraNav ${menu ? "isActive" : ""}`}>
            <ul className="cabeceraLista">
                ...
                <li className="lista"><NavLink className={"lista"} to={"/category/Comun"}>Comun</NavLink></li> 
                <li className="lista"><NavLink className={"lista"} to={"/category/Raro"}>Raro</NavLink></li> 
                <li className="lista"><NavLink className={"lista"} to={"/category/Superaro"}>Superaro</NavLink></li>
                {cart.length > 0 ? 
                    <NavLink to={"/cart"}>        
                        <CartWdget/>        
                    </NavLink> 
